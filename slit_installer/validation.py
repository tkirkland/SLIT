...
def validate_username(username: str) -> bool:
    ...
    reserved_names = {
        ...
        'messagebus', 'systemd-coredump', 'systemd-oom', 'sshd', 'chrony',
        'postfix', 'tcpdump', 'tss', 'polkitd', 'unbound', 'sssd', 'cockpit-ws',
        'cockpit-wsinstance', 'setroubleshoot', 'insights', 'clevis', 'pesign',
        'flatpak', 'geoclue', 'gnome-initial-setup', 'saned', 'colord',
        'avahi', 'pulse', 'gdm', 'gnome-remote-desktop', 'rpc', 'gluster',
        'saslauth', 'apache', 'qemu', 'kvm', 'render', 'pipewire', 'rtkit',
        'test', 'guest', 'admin', 'administrator', 'user', 'default'
    }
...
def validate_locale(locale_string: str) -> bool:
    ...
    valid_locales = {
        ...
        'pt_BR.UTF-8', 'pt_PT.UTF-8', 'ru_RU.UTF-8', 'zh_CN.UTF-8',
        'zh_TW.UTF-8', 'ja_JP.UTF-8', 'ko_KR.UTF-8', 'ar_SA.UTF-8',
        'hi_IN.UTF-8', 'th_TH.UTF-8', 'tr_TR.UTF-8', 'pl_PL.UTF-8',
        'nl_NL.UTF-8', 'sv_SE.UTF-8', 'da_DK.UTF-8', 'no_NO.UTF-8',
        'fi_FI.UTF-8', 'cs_CZ.UTF-8', 'hu_HU.UTF-8', 'ro_RO.UTF-8',
        'bg_BG.UTF-8', 'hr_HR.UTF-8', 'sk_SK.UTF-8', 'sl_SI.UTF-8',
        'et_EE.UTF-8', 'lv_LV.UTF-8', 'lt_LT.UTF-8', 'uk_UA.UTF-8',
        'be_BY.UTF-8', 'mk_MK.UTF-8', 'mt_MT.UTF-8', 'is_IS.UTF-8',
        'ga_IE.UTF-8', 'cy_GB.UTF-8', 'eu_ES.UTF-8', 'ca_ES.UTF-8',
        'gl_ES.UTF-8', 'oc_FR.UTF-8', 'br_FR.UTF-8', 'kw_GB.UTF-8',
        'gd_GB.UTF-8', 'gv_GB.UTF-8'
    }
...
def validate_timezone(timezone_string: str) -> bool:
    ...
    valid_timezones = {
        ...
        'Europe/Moscow', 'Europe/Kiev', 'Europe/Bucharest', 'Europe/Athens',
        'Europe/Istanbul', 'Europe/Dublin', 'Europe/Lisbon',
        'Asia/Tokyo', 'Asia/Shanghai', 'Asia/Hong_Kong', 'Asia/Singapore',
        'Asia/Mumbai', 'Asia/Kolkata', 'Asia/Dubai', 'Asia/Riyadh',
